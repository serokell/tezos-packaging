# SPDX-FileCopyrightText: 2025 Oxhead Alpha
# SPDX-License-Identifier: LicenseRef-MIT-OA

class TezosExperimentalAgnosticBaker < Formula
  @all_bins = []
  ...
  def install
    make_deps
    install_template "src/bin_agnostic_baker/main_agnostic_baker.exe",
                     "_build/default/src/bin_agnostic_baker/main_agnostic_baker.exe",
