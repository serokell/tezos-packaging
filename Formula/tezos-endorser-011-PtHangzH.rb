...
class TezosEndorser011Pthangzh < Formula
  ...
  bottle do
    ...
    sha256 cellar: :any, catalina: "be503a9007a391925607fb324aa1da255c118e8d8153d124f700967be95baddf"
    sha256 cellar: :any, mojave: "0301bf4165163cf3472de9a07a45bcf4d0194f3984ae3eadf03596f9d2897335"
  end
  ...
  def install
    startup_contents =
      ...
      endorser="#{bin}/tezos-endorser-011-PtHangzH"
    ...
    EOS
    File.write("tezos-endorser-011-PtHangzH-start", startup_contents)
    bin.install "tezos-endorser-011-PtHangzH-start"
    make_deps
    install_template "src/proto_011_PtHangzH/bin_endorser/main_endorser_011_PtHangzH.exe",
                     "_build/default/src/proto_011_PtHangzH/bin_endorser/main_endorser_011_PtHangzH.exe",
                     "tezos-endorser-011-PtHangzH"
  end

  plist_options manual: "tezos-endorser-011-PtHangzH run"
  def plist
    <<~EOS
      ...
      <plist version="1.0">
        <dict>
          ...
          <key>Program</key>
          <string>#{opt_bin}/tezos-endorser-011-PtHangzH-start</string>
