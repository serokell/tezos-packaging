...
# that option reflects launchpad and copr build infrastruture
# and has a purpose to behave more similar to them
images = ["36"] if target_os == "fedora" else distributions
...
for dist in images:
    ...
    -f docker/packaging/Dockerfile-{target_os} --build-arg dist={dist} .
    """
    )
