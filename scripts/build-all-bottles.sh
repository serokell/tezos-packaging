...
formulae=("tezos-accuser-PtMumbai" "tezos-admin-client" "tezos-baker-PtMumbai" "tezos-client" "tezos-codec" "tezos-node" "tezos-signer" "tezos-smart-rollup-client-PtMumbai" "tezos-smart-rollup-node-PtMumbai")
