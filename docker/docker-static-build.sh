...
"$virtualisation_engine" build -t alpine-tezos-dalphanet -f "$docker_file" --build-arg TEZOS_VERSION="$TEZOS_VERSION" .
container_id="$("$virtualisation_engine" create alpine-tezos-dalphanet)"
