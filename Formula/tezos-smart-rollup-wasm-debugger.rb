...
class TezosSmartRollupWasmDebugger < Formula
  ...
  url "https://gitlab.com/tezos/tezos.git", :tag => "octez-v21.1", :shallow => false
  ...
  bottle do
    ...
    sha256 cellar: :any, ventura: "6baa78f13be5f2b038ffaf43a17f57d856959ab2962891dd89a4edd4fce8f3a4"
  end
