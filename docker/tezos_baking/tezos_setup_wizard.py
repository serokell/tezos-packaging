...
from tezos_baking.wizard_structure import get_data_dir
...
class Setup(wizard_structure.Setup):
    ...
    def import_snapshot(self):
        ...
        while not valid_choice:
            ...
            self.ensure_step(snapshot_mode_query)
    ...
    def import_baker_key(self):
        ...
        if replace_baker_key:
            ...
            key_mode_query = get_key_mode_query(key_import_modes_list)
