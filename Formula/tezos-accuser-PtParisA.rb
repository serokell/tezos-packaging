...
class TezosAccuserPtparisa < Formula
  @all_bins = []
  ...
  url "https://gitlab.com/tezos/tezos.git", :tag => "octez-v20.0-beta1", :shallow => false
  ...
  bottle do
    root_url "https://github.com/serokell/tezos-packaging/releases/download/#{TezosAccuserPtparisa.version}/"
  end
  ...
  def install
    startup_contents =
      ...
      accuser="#{bin}/octez-accuser-PtParisA"
    ...
    EOS
    File.write("tezos-accuser-PtParisA-start", startup_contents)
    bin.install "tezos-accuser-PtParisA-start"
    make_deps
    install_template "src/proto_019_PtParisA/bin_accuser/main_accuser_019_PtParisA.exe",
                     "_build/default/src/proto_019_PtParisA/bin_accuser/main_accuser_019_PtParisA.exe",
                     "octez-accuser-PtParisA"
  end

  service do
    run opt_bin/"tezos-accuser-PtParisA-start"
    require_root true
    environment_variables TEZOS_CLIENT_DIR: var/"lib/tezos/client", NODE_RPC_SCHEME: "http", NODE_RPC_ADDR: "localhost:8732"
    keep_alive true
    log_path var/"log/tezos-accuser-PtParisA.log"
    error_log_path var/"log/tezos-accuser-PtParisA.log"
  end
