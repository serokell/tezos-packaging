...
class TezosBakerPtparisa < Formula
  @all_bins = []
  ...
  bottle do
    root_url "https://github.com/serokell/tezos-packaging/releases/download/#{TezosBakerPtparisa.version}/"
  end
  ...
  def install
    startup_contents =
      ...
      baker="#{bin}/octez-baker-PtParisA"
    ...
    EOS
    File.write("tezos-baker-PtParisA-start", startup_contents)
    bin.install "tezos-baker-PtParisA-start"
    make_deps
    install_template "src/proto_019_PtParisA/bin_baker/main_baker_019_PtParisA.exe",
                     "_build/default/src/proto_019_PtParisA/bin_baker/main_baker_019_PtParisA.exe",
                     "octez-baker-PtParisA"
  end

  service do
    run opt_bin/"tezos-baker-PtParisA-start"
    require_root true
    ...
    keep_alive true
    log_path var/"log/tezos-baker-PtParisA.log"
    error_log_path var/"log/tezos-baker-PtParisA.log"
  end
